...
export default function Benefits() {
  ...
  return (
    <div className="py-10 md:py-20 bg-gray-50 last:mb-0 px-3 md:px-0">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-x-4 gap-y-8">
          ...
          {cards?.map((card, index) => (
            <div
              key={index}
              className="col-span-1 p-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 relative transition-all cursor-pointer hover:bg-[#0e8ac822] text-center"
            >

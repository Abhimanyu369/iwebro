...
const Login = () => {
  ...
  const Logdata = JSON.parse(sessionStorage.getItem('admin'));
  ...
  const fetchData = async (e) => {
    try {
      let fdata = await axios.post(BACKEND_COMMAN_URL + '/api/login', data, headers);
      console.log(fdata);
      if (fdata.status === 200) {
        sessionStorage.setItem('admin', JSON.stringify(fdata.data.token));
        navigate('/admin');
      }
      else {
        e.preventDefault();
          ...
          <div className="flex flex-wrap items-center justify-center h-screen">
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 wow animated fadeInRight">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <h2 className="mb-9 text-4xl font-bold text-black sm:text-title-xl2">Sign In to Admin Panel</h2>
                ...
                <form method="post" onSubmit={formSubmit}>
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      <input type="text" placeholder="Enter your email" id='email' name="email" onChange={formEvent} className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      <input type="password" placeholder="Enter Your Password" id='password' name="password" onChange={formEvent} className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                      <span className="absolute right-4 top-4">
                        <svg className="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                          <g opacity="0.5">
                  ...
                  <div className="mb-5">
                    <input type="submit" value="Sign In" className="w-full cursor-pointer rounded-lg border border-primary bg-primary px-4 py-3 font-medium text-white transition hover:bg-opacity-90" />
                  </div>

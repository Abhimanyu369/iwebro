...
const Add_remote_hiring = () => {
  ...
  const fetchData = async (data) => {
    ...
    let fdata = await axios.post(BACKEND_COMMAN_URL + '/api/addRemoteHiring', formData, headers);
    if (fdata.status === 200) {
      navigate('/View_remote_hiring');
    }
    else {
      navigate('/Add_remote_hiring');
    }
  }
        ...
        <div className="container">
          <form onSubmit={formSubmit} method="post" encType="multipart/form-data" className='flex flex-wrap'>
            <div className="w-full">
              <h2 className="mb-4" style={{ letterSpacing: '3px', fontWeight: 600 }}>Add Remote Hiring </h2>
...
export default Add_remote_hiring;
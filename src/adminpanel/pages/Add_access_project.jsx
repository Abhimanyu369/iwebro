...
const Add_access_project = () => {
  ...
  const fetchData = async (data) => {
    ...
    let fdata = await axios.post(BACKEND_COMMAN_URL + '/api/addAccessProject', formData, headers);
    if (fdata.status === 200) {
      navigate('/View_access_project');
    }
    else {
      navigate('/Add_access_project');
    }
  }
        ...
        <div className="container">
          <form onSubmit={formSubmit} method="post" encType="multipart/form-data" className='flex flex-wrap'>
            <div className="w-full">
              <h2 className="mb-4" style={{ letterSpacing: '3px', fontWeight: 600 }}>Add Access Project </h2>
...
export default Add_access_project;
...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    let data = await axios.get(BACKEND_COMMAN_URL + '/api/fetch_data', headers);
    if (data.status === 200) {
  ...
  const fetchData2 = async () => {
    let data = await axios.get(BACKEND_COMMAN_URL + '/api/fetch_data2', headers);
    if (data.status === 200) {
  ...
  const fetchData3 = async () => {
    let data = await axios.get(BACKEND_COMMAN_URL + '/api/fetch_data3', headers);
    if (data.status === 200) {
      setData3(data.data);
    }
  }
        ...
        <main>
          <div className="ml-305 p-4 md:p-6 2xl:p-10">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                ...
                <div className="mt-4">
                  <div className='mb-4'>
                    <h4 className="text-title-md font-bold text-black mb-0">
                      {data3.data1 ? data3.data1 + ' Job Requirements' : '0 Job Requirements'}
                    </h4>
                  </div>
                  <span className="flex justify-end gap-1 text-sm font-medium text-meta-3">
              ...
              <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark px-3">
                <div className="h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                  <svg className="fill-primary" width="20" height="22" viewBox="0 0 20 22" fill="#000"
                ...
                <div className="mt-4">
                  <div className='mb-4'>
                    <h4 className="text-title-md font-bold text-black mb-0">
                      {data3.data2 ? data3.data2 + ' Companys' : '0 Companys'}
                    </h4>
                  </div>
              ...
              <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark px-3">
                <div className="h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                  <svg className="fill-primary" width="22" height="22" viewBox="0 0 22 22" fill="#000"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mt-4">
                  <div className='mb-4'>
                    <h4 className="text-title-md font-bold text-black mb-0">
                      {data3.data3 ? data3.data3 + ' Developers' : '0 Developers'}
                    </h4>
                  </div>
                  <span className="flex justify-end gap-1 text-sm font-medium text-meta-3">
                    Total Developers
              ...
              <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark px-3">
                <div className="h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                  <svg className="fill-primary" width="22" height="18" viewBox="0 0 22 18" fill="#000"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mt-4">
                  <div className='mb-4'>
                    <h4 className="text-title-md font-bold text-black mb-0">
                      {data3.data4 ? data3.data4 + ' Hire Users' : '0 Hire Users'}
                    </h4>
                  </div>
                  <span className="flex justify-end gap-1 text-sm font-medium text-meta-5">
                    Total Hire Users
                  </span>
                </div>
              </div>

...
const Update_access_project = () => {
  ...
  const fetchData = async (e) => {
    ...
    let Fdata = await axios.put(BACKEND_COMMAN_URL + '/api/editAccessProject/' + id, formData, headers);
    if (Fdata.status === 200) {
  ...
  const fetchData2 = async () => {
    const data = await axios.get(`${BACKEND_COMMAN_URL}/api/singleAccessProject/${id}`, headers);
    if (data.status === 200) {
...
export default Update_access_project;
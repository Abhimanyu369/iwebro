...
const Register = () => {
  ...
  const fetchData = async (e)=>{
    try {
      let fdata = await axios.post(BACKEND_COMMAN_URL+'/api/register', data, headers);
      if(fdata.status === 200){
        navigate('/login');
      }
      else{
        ...
        <div className="max-w-screen-2xl mx-auto">
          <div className="rounded-sm bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="flex flex-wrap items-center justify-center h-screen">
              <div className="hidden w-full xl:block xl:w-1/2 wow animated fadeInLeft">
                <div className="py-17.5 px-26 text-center">
                  <span className="mb-5.5 inline-block">
                    <h2 className='mb-2'>Iwebro</h2>
                  </span>

                  <p className="font-medium mb-4 2xl:px-20">
              ...
              <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 wow animated fadeInRight">
                <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                  <span className="mb-1.5 block font-medium">Start for free</span>
                  <h2 className="mb-9 text-4xl font-bold text-black sm:text-title-xl2">Sign Up to Iwebro</h2>

                  <form onSubmit={formSubmit} method="post">
                    <div className="mb-4">
                      <label className="mb-2.5 block font-medium text-black">Name</label>
                      <div className="relative">
                        <input name="username" id='username' onChange={formEvent} type="text" placeholder="Enter your full name" className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        <input name="email" id='email' onChange={formEvent} type="email" placeholder="Enter your email" className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        <span className="absolute right-4 top-4">
                          <svg className="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.5">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        <input name="password" id='password' onChange={formEvent} type="password" placeholder="Enter your password" className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        <span className="absolute right-4 top-4">
                          <svg className="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.5">
                    ...
                    <div className="mb-6">
                      <label className="mb-2.5 block font-medium text-black">Confirm Password</label>
                      <div className="relative">
                        <input name="cpassword" id='cpassword' onChange={formEvent} type="password" placeholder="Enter your confirm password" className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                        <span className="absolute right-4 top-4">
                          <svg className="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.5">
                    ...
                    <div className="mb-5">
                      <input type="submit" value="Create account" className="w-full cursor-pointer rounded-lg border border-primary bg-primary py-3 px-4 font-medium text-white transition hover:bg-opacity-90" />
                    </div>
